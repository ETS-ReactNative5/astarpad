...
import Wolfden from '../../images/Wolfden.png';
import Undead from '../../images/Undeadd.png';
...
const Collection = () => {
    ...
    const init = async () => {
        ...
        //  alert(rows);
        try{
        let _result = await fetch('https://address-marketplace.herokuapp.com/api/marketplace/lister/undead/'+address);
  ...
  const getAllStatus =  async () => {
    ...
    let _getURI = "https://address-marketplace.herokuapp.com/api/marketplace/undead" ; 
    let _imported = await fetch(_getURI) ;
    _imported = await _imported.json() ;
...
useEffect(() => {
  ...
  const oloadmore = () => {
    ...
    details['0xFA54B0E031148CB9dcf71c3c571441691C6FCaC8'] = {
      name: "Undead",
      banner : Undead
    } ; 

    details['0x4483aF89d86114e2f8B16b15D64C84241922ed78'] = {
      name: "Dark Knight",
      banner : DarkKnight
    } ; 
    ...
    return(
      ...
      <Header />
      <div className="marketplace-sec2" style={{minHeight: '100vh'}}>
