...
const Explore = () => {
    ...
    const getImportedCollection = async () => {
      ...
      let _getURI = "https://dev.wizard.financial/api/undead/getnftuser/"+_user ; 
...
useEffect(() => {
  ...
  const oloadmore = () => {
    ...
    const importTokens = () => {
      ...
      setApiModal(true) ;
      axios 
      .post("https://dev.wizard.financial/api/undead/addnftuser", formData
        ) 
      .then((response) => {
          ...
          <div className="row">
              <div className="col-lg-12">
                ...
                <li class="tab-button"><a href="#" class="tab-link active" data-tab="onsale">Auction</a></li>
                  ...
                  <li class="tab-button"><a href="#" class="tab-link" data-tab="imported"> Imported Collection</a></li>

                </ul>
                <ul class="tabs5 pull-right">
                <li ><a href="/collection"  >Your Listing</a></li>
                </ul>
                </div>
