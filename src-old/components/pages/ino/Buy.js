...
const Buy = (props) => {
    ...
    let details = {} ; 
    details['0x79d2e6fB826659a1EE265355813eFfB0E05AD2C9'] = {
        title : "Wolf Saw Exclusive",
        description: "Wolfsaw Exclusive - Rare Mint - The holder of this NFW will get airdropped 1 of 420 (out of 10,000 total) rare Wolf Saw NFW on the date of the collection reveal.",
        image : add 
    } ;
    details['0x7Ff04ac7271cA1FF9A8b687616C82E2A5668d769'] = {
        title : "MiniPanther",
        description: "Mint your Unique MiniPanther's NFT Now! Only 2000 NFTs are available to be delivered on first come first serve basis.",
        image : MiniPanthe 
    } ;
