	...
	//   })
      ...
      const init = async () => {
        ...
        setAllowance(_allowance)
            ...
            setContribution( parseFloat(_contribution/1e1 ** _rTokenDetails[2]).toFixed(2));
        ...
        let url  = '' ;
        if( _presaleDetails.website){
             url = _presaleDetails.website.replace(/\/$/, "")+"/logo.png" ;
...
const checkWhiteList = async() => {
      ...
      const depositMax = () => {
		let _web3 = new Web3(web3Provider);
        let _maxAllocation = parseFloat(presale.maxAllocation/1e1 ** raiseTokenDetails[2])
    ...
    const changeSaleTokenLimit = () => {
        ...
        let _saleTokenLimit = parseInt(saleTokenLimit); 
  
        _saleTokenLimit = _web3.utils.toBN(_saleTokenLimit).mul(_web3.utils.toBN(1e1 ** saleTokenDetails[2])) ;
		setModal(!modal);
                                                ...
                                                }
 {
                                        ...
                                        <div className="mt-4">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td className="abcd">Max Allocation</td>
                                                    <td className="abcde">{parseFloat(presale.maxAllocation/1e1 ** raiseTokenDetails[2]).toFixed()} {raiseTokenDetails[1]}</td>
                                                </tr>
                                                {
                                                    publicSale &&
                                                    <>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="abcde">1 {raiseTokenDetails[1]} = {parseFloat(presale.saleRate/1e1 ** tokenDetails[2]).toFixed(2)} {tokenDetails[1]}</td>
                                                </tr>
                                                {
                                                    publicSale &&
                                                    <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="abcde">{parseFloat(presale.softcap/1e1 ** raiseTokenDetails[2]).toFixed(2)} {raiseTokenDetails[1]}</td>
                                                </tr>
                                                <tr>
                                                    <td className="abcd">Hard Cap</td>
                                                    <td className="abcde">{parseFloat(presale.hardCap/1e1 ** raiseTokenDetails[2]).toFixed(2)} {raiseTokenDetails[1]}</td>
                                                </tr>
                                                <tr>
                            ...
                            <div className="list-box-l2">
                                <div className="bnb-wrp">
                                   
                                    {
                                        status > 0  &&
                                        <>
                                    <p className=""><span> {parseFloat(presale.raisedAmount/1e1 ** raiseTokenDetails[2]).toFixed(2)}/{parseFloat(presale.hardCap/1e1 ** raiseTokenDetails[2]).toFixed(2)} </span> {raiseTokenDetails[1]}</p>
                                    <div>
                                                    ...
                                                    }
{
                                                 ...
                                                 <a  onClick={checkWhiteList} >Check Whitelist</a>
                                             {
                                              ...
                                              <>
                                                 ...
                                                 {/* {
                                                    wallet.account ==  presale.creator && wallet.account != "0x056684669C0D5148E4D24E538dD01966637622B2"  &&  presale.status != 2 && 
                                                      <>
                                             ...
                                             }
                                              {
                                                   wallet.account == presale.creator  && presale.status == 2 && 
                                                    ...
                                                    {
                                                   wallet.account == presale.creator  && presale.status == 4 && 
                                                      <>
